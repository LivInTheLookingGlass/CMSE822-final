...
int main (int argc, char* argv[]) {
	...
	if (argc != 5)
    	cout << "Please give step size, time step, thread count, and chunk size" << endl;
...
// 		cout << "delta t: " << delta_t << endl; 
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 	...
	 	for(int t=0; t<n; ++t)
	 	{
	       ...
	       // #pragma omp parallel for schedule(static,chunk_size) num_threads(thrd_cnt)
	       // #pragma omp parallel for schedule(dynamic,chunk_size) num_threads(thrd_cnt)
	        #pragma omp parallel for schedule(guided,chunk_size) num_threads(thrd_cnt)
